...
namespace NetCartoDB.Map.WinForms.Design
{
    ...
    public class UIExpandibleEditorBase<T> : ExpandableObjectConverter where T : new()
    {
    ...
    [PermissionSet(SecurityAction.Demand, Name = "FullTrust")]
    public class UIExpandibleComplexEditorBase<T> : ExpandableObjectConverter /*: UIExpandibleEditorBase<T> */ where T : ITConvertSerializer, new()
    {
        public override bool GetPropertiesSupported(ITypeDescriptorContext context)
        {
            return true;
